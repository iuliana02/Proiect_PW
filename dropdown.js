  ...
  $('#menuBackground').css('width','1000px');
  $('#menuBackground').css({'vertical-align':'top', 'margin': 'auto', 'padding': '0', 'font-family': 'Arial, Helvetica, sans-serif', 'font-size': '18px', 'font-weight': 'bold', 'line-height': '150%', 'background-color': ' #d4d4f7'});
  $("#menuBackground").css({'text-align':'center'});
  $('#dropDownMenu a').css({'color':'black', 'padding':'10px 20px', 'display':'block', 'text-decoration':'none'});
